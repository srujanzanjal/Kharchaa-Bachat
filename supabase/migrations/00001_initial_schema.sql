-- ============================================================================
-- KHARCHAA BACHAT — PHASE 3 DATABASE ARCHITECTURE
-- ============================================================================
-- Complete PostgreSQL schema, ledger design, idempotent catch-up processor,
-- atomic expense management, and Row Level Security.
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS expenses (
  ...
  coverage_from         uuid REFERENCES profiles(id),
...
BEGIN
  -- Lock the ledger records for this household during the transaction
